        ...
        <section class="chat">
            ...
            <form action="" class="type-area" id="form" autocomplete="off">
                ...
                <div>
                    ...
                    <input type="textarea" id="msg" name="inputfeild" style="width: 350px; font-size:18px; margin-left: 7px; margin-right: 7px; border:none; height: 26px;"  placeholder="Type a message" autofocus/>
                </div>
                <div class="send">
