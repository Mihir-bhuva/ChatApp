            ...
            <form action="#" id="form" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="picture" >
                    <div class="cameraicon" >
                        <input type="file" value="" id="inputimage"  name="image" hidden> 
                        <i style="font-size:24px; "  onclick="wow()" class="fa fa-camera"id="camera" ></i>
                        
                    </div> 
                  
                    <label style="padding-top: 12px;
                    margin-left: 10px;"  for="">Select Profile Picture  </label>
